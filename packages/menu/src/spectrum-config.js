...
/**
 * @type {
 *     import('../../../tasks/spectrum-css-converter.js').SpectrumCSSConverter }
 */
const config = {
  conversions :
      [
        {
          ...
          components : [
            converter.classToClass('spectrum-Menu-sectionHeading', 'header'),
          ],
        },
        {
          // Menu Item
          ...
          components : [
            ...
            converter.classToClass('spectrum-Menu-chevron--withAdjacentIcon',
                                   'chevron--withAdjacentIcon'),
            converter.classToClass('spectrum-Menu-checkmark', 'checkmark'),
            converter.classToClass('spectrum-Menu-checkmark--withAdjacentIcon',
                                   'checkmark--withAdjacentIcon'),
            converter.classToAttribute('spectrum-Menu-item--drillIn',
                                       'has-submenu'),
            converter.classToSlotted('spectrum-Icon', 'icon'),
            converter.classToSlotted('spectrum-Menu-itemIcon', 'icon'),
            converter.classToSlotted('spectrum-Menu-itemIcon--workflowIcon',
                                     'icon'),
            ...
            converter.classToClass('spectrum-menu-itemSelection',
                                   'menu-itemSelection'),
            {
              find : {
                type : 'pseudo-class',
        ...
        },
        {
          ...
          includeByWholeSelector : [
            ...
            /* [dir=ltr] .spectrum-Menu.is-selectable
